...
public class DateUtil extends Object {
    ...
    public static void main(String[] args) throws ParseException {
    	...
    	System.out.println(DateUtil.getHourBetween(
				DateUtil.getCertainDatetime(sdf.format(new Date()), -1),
				sdf.format(new Date())));;
    	System.out.println( redMonth("2017-09-29"));
     ...
     * @return 当月的第一天和最后一天
     */
    public static Map<String, Object> getMonthStartAndEnd(String date, int offset) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Calendar cal = Calendar.getInstance();
