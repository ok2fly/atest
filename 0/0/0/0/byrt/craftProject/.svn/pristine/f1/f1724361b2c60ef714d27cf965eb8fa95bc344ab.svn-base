...
import com.craft.pojo.InterfaceConstants;
import com.craft.pojo.UserConstants;
...
//	private GetMobelNum getMobelNum;
	...
	public Integer sendSms(String mobile, Integer requestType, String tel) throws UnsupportedEncodingException {
		...
		sb.append(InterfaceConstants.SMS_USERNAME);
		sb.append(InterfaceConstants.SMS_PASSWORD);
		sb.append(InterfaceConstants.SMS_APIKEY);
		
		sb.append(mobile);
		
		sb.append(InterfaceConstants.SMS_ENCODE);
		sb.append(InterfaceConstants.SMS_CONTENTFST);
		sb.append(x_param);
		sb.append(InterfaceConstants.SMS_CONTENTLST);
