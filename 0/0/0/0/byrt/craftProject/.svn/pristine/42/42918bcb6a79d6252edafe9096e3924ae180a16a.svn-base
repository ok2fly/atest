...
public class SFTP {
	 ...
	 * @param sftp
	 */
	public void upload(String directory, CommonsMultipartFile file, ChannelSftp sftp,String fileName) {
		try {
			
			InputStream fil = file.getInputStream();
			sftp.cd(directory);
			//File file = new File(uploadFile);
			sftp.put(fil, fileName);
...
//		String uploadFile = "D:\\1.png";
//		String downloadFile = "1.png";
//		String saveFile = "D:\\1.png";
//		String deleteFile = "1.png";
