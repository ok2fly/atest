...
<div class="cont">
					 ...
					 <div class="bbox clearfix" id="imgbox1">
						<div class="upimgone">
							<div class="imgone">
								...
								<img id="imgbox1file1-check" alt="" name="pic" style="width: 160px;height: 160px; border: none;">
							</div>
						</div>
						<div class="upimgone">
							<div class="imgone">
								<input type="file" id="imgbox1file2"     name="files" onchange="change(this)">
								<img id="imgbox1file2-check" alt="" name="pic" style="width: 160px;height: 160px; border: none;">
							</div>
						</div>
						<div class="upimgone">
							<div class="imgone">
								<input type="file" id="imgbox1file3"   name="files" onchange="change(this)">
								<img id="imgbox1file3-check" alt="" name="pic" style="width: 160px;height: 160px; border: none;">
							</div>
						</div>
						<div class="upimgone">
							<div class="imgone">
								<input type="file" id="imgbox1file4"   name="files" onchange="change(this)">
								<img id="imgbox1file4-check" alt="" name="pic" style="width: 160px;height: 160px; border: none;">
							</div>
						</div>
						<div class="upimgone">
							<div class="imgone">
								<input type="file" id="imgbox1file5"   name="files" onchange="change(this)">
								<img id="imgbox1file5-check" alt="" name="pic" style="width: 160px;height: 160px; border: none;">
							</div>
						</div>
					</div>  
				</div>
				...
				<div class="upinfobox">
					...
					<div class="oneline">
						...
						<div class="oneinfo timer">
							...
							<div class="rightin">
								<input type="text" name="creativeTime" class="tcal" class="Wdate"  onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
							</div>
						</div>
					</div>
					<div class="oneline">
		...
		<div class="w100">
			<!-- <div class="textinfo">参赛声明：我（们）以作者身份在此声明，以上参赛作品为我（们）的原创作品，不涉及或侵占他人的版权或著作权</div>
	...
	/* var $_model_clone;
	$(function(){
		$_model_clone = $("div.uploadmodel:first").clone(true);
	}) */
				...
				if("0"==data.status){
					var json = data.data;
					 if(json.basUser.length > 0 ){
						 ...
						 window.location.href = url+"commens/entry.htm";
					 }
				}
			}
		})
	...
	function checkBeforeUpdate(){
 	...
 	$("div.uploadbtn").on("click",function(){
		...
		/*  formFile.append("opusName", works.opusName);  
        formFile.append("groupId", works.groupId);  
        formFile.append("creativeTime", works.creativeTime);  
        formFile.append("material", works.material);  
        formFile.append("productionProcess", works.productionProcess);  
        formFile.append("introduction", works.introduction);   */
		...
		/* var piclist = [];
		if(works.file1 != "" && works.file1 != undefined && works.file1 != null ){
			piclist.push(works.file1);
		}
		if(works.file2 != "" && works.file2 != undefined && works.file2 != null ){
			piclist.push(works.file2);
		}
		if(works.file3 != "" && works.file3 != undefined && works.file3 != null ){
			piclist.push(works.file3);
		}
		if(works.file4 != "" && works.file4 != undefined && works.file4 != null ){
			piclist.push(works.file4);
		}
		if(works.file5 != "" && works.file5 != undefined && works.file5 != null ){
			piclist.push(works.file5);
		} */
		
		var formFile = new FormData($('#uploadModel')[0]);
		/* formFile.append("files",piclist); */
		var indexlayer = layer.load(1, {
			  shade: [0.5,'#fff'] //0.1透明度的白色背景
		});
		//var indexlayer = layer.load(2,{shade:0.5}); //启动loding效果
 		$.ajax({  
		    type: "POST",  
 	...
 	function uploadCallback(a){
	 	var addPic = $(a).val();
	 	console.log(addPic);
	 	$(a).parent(".imgone").css("background-image","url("+addPic+")");
 	}
